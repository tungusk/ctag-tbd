...
- "src_root"/sdcard_image/factory/plugins/mui-"id".json has to have same information as json above, add possible parameters for ui rendering
- "src_root"/sdcard_image/factory/plugins/mp-"id".json has to have parameter values of all parameters included in ui, at least one preset definition
